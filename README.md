...
*Um jogo de mistério psicológico sobre tempo, memória e liberdade*

[Visão Geral](#-visão-geral) • [Mecânicas](#-mecânicas-principais) • [História](#-história) • [Controles](#-controles) • [Como Jogar](#-como-jogar)
...
**Ciclo das 20** é um jogo de mistério e exploração 2D onde você está preso em um hospital psiquiátrico e precisa descobrir como escapar antes que seja tarde demais. Com apenas **10 dias** para encontrar a saída, cada decisão conta e cada ciclo traz você mais perto da verdade — ou do fim.
...
Você é um paciente **injustamente internado** em um hospital psiquiátrico por um erro médico. Acusado de loucura, sua única esperança está em descobrir o que o segurança da entrada precisa para te libertar sem levantar suspeitas.

Mas há um problema: **todos os dias às 20h, as portas se trancam**. E às 22h, o ciclo recomeça.

Durante o dia, funcionários e pacientes podem oferecer dicas valiosas. Mas quando a noite cai, tudo muda — aliados se calam e a exploração se torna **perigosa**.

> *"A maior traição do ser humano é sua própria mente..."*

Você tem **10 dias** para escapar. Passado esse tempo, será tarde demais.
...
Descubra a **senha da porta de saída** explorando o hospital, conversando com NPCs e conectando as pistas. Cada dia é uma nova oportunidade de chegar mais perto da verdade.

**Você conseguirá escapar antes do 11º dia?**

---

## 🎮 Como Jogar

**Jogue agora em:** [LINK_DO_ITCH_IO_AQUI]
...
**Desenvolvedoras**: [Victória de Oliveira Farias, Marinna Grigolli Cesar, Roberta Barros Teixeira Pereira]
**Engine**: Unity 2D
...
**Boa sorte em sua fuga! 🗝️**

*Você tem 10 dias. O tempo está passando...*
